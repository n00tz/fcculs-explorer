...
CREATE MATERIALIZED VIEW IF NOT EXISTS identity_by_frn AS
...
CREATE MATERIALIZED VIEW IF NOT EXISTS towers_by_site AS
SELECT
...
CREATE INDEX IF NOT EXISTS idx_towers_by_site_key ON towers_by_site (lat_site_key, lon_site_key);
...
CREATE MATERIALIZED VIEW IF NOT EXISTS entities_by_address AS
SELECT
